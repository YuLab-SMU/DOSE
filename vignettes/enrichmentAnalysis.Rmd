...
We provide enrichment analysis in `r Biocpkg("clusterProfiler")`[@yu_clusterprofiler_2012] for GO, KEGG, MeSH, DAVID, Molecular Signatures Database and others (user's annotation), and Reactome pathway enrichment analysis in `r Biocpkg("ReactomePA")`[@yu_reactomepa_2016] package. Both hypergeometric test and GSEA are supported.
