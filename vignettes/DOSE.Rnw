...
\begin{abstract}
  ...
  \begin{center}
    ...
    \begin{tabular}{ | l | }
      ...
      \emph{Bioinformatics} 2015, Accepted. \\
...
\\
\\
Here, we present an \textsf{R} package \Biocpkg{DOSE} for analyzing semantic similarities among DO terms and gene products annotated with DO terms, and extracting disease association insight from genome wide expression profiles.
\\
\\
...
<<cnetplot, fig.cap="cnetplot of DO enrichment result.", fig.align="center", fig.height=16, fig.width=16>>=
...
<<clusterProfiler, fig.cap="DOSE with clusterProfiler.", fig.align="center", fig.height=6, fig.width=6, out.width="0.6\\textwidth">>= 
...
<<gseaplot, fig.cap="gseaplot example.", fig.align="center", fig.height=6, fig.width=6, out.width="0.6\\textwidth">>=  
topID <- res[1,1]
topID
