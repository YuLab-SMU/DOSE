...
#' 1.1.2\cr Date: \tab 12-28-2011\cr biocViews:\tab Bioinformatics,
...
#' @seealso \linkS4class{DOParams}, \linkS4class{enrichDOResult}
#' @keywords package
NULL
...
#'
#' @name DataSet
#' @aliases EG2DO DO2EG IC Info_Contents_human_DO
#' @docType data
#' @keywords datasets
NULL
