...
% \VignetteDepends{AnnotationDbi, DO.db, methods, fdrtool, stats, plyr}
...
Disease Ontology (DO) provides an open source ontology for the integration of biomedical data that is associated with human disease. DO analysis can lead to interesting discoveries that deserve futher clinical investigation. 
